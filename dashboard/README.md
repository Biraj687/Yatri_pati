# Nepal Explain News Management Dashboard

A professional, production-ready React-based news management dashboard for the Nepal Explain news portal.

## Features

### 📰 News Management
- **Create, Edit, Delete** articles with full content management
- **Multiple Authors** support with default "Nepal Explain" author
...
Proprietary - Nepal Explain News Portal
