...
import { DashboardHome, NewsManagementPage, AnalyticsPage, SettingsPage, AdvertisementManagementPage, } from '@pages';
import { appConfig } from './config';
function AppRoutes() {
    return (_jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(DashboardLayout, { children: _jsx(DashboardHome, {}) }) }), _jsx(Route, { path: "/news", element: _jsx(DashboardLayout, { children: _jsx(NewsManagementPage, {}) }) }), _jsx(Route, { path: "/analytics", element: _jsx(DashboardLayout, { children: _jsx(AnalyticsPage, {}) }) }), _jsx(Route, { path: "/settings", element: _jsx(DashboardLayout, { children: _jsx(SettingsPage, {}) }) }), _jsx(Route, { path: "/advertisements", element: _jsx(DashboardLayout, { children: _jsx(AdvertisementManagementPage, {}) }) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }));
}
function App() {
