...
export function FileManagerPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-secondary-700">File Manager</h1>
        <p className="text-gray-600 mt-2">Upload, manage, and organize your files</p>
      </div>

      {/* Upload Section */}
      <div className="bg-white rounded-lg shadow p-8">
        <h2 className="text-lg font-semibold text-secondary-700 mb-4">Upload Files</h2>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-secondary-700">Files ({files.length})</h2>
