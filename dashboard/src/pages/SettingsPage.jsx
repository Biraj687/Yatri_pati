...
export function SettingsPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-secondary-700">Dashboard Settings</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Section title="General Settings" description="Basic site information">
          <div className="space-y-4">
            ...
            <FormGroup label="Logo" error={errors.logoUrl?.message}>
              <div className="flex gap-4 items-center">
                <label className="cursor-pointer bg-white px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-blue-500">
                      ...
                      if (file) {
                        ...
                        reader.onloadend = () => {
                          ...
                          if (input) {
                            ...
                            nativeInputValueSetter.call(input, reader.result);
                ...
                <input
                  ...
                  id="logo-url-input"
                  type="text"
                  className="w-full px-4 py-2 border border-gray-300 bg-gray-50 text-gray-400 rounded-lg focus:ring-2 focus:ring-blue-500 hidden"
                  placeholder="Base64 URL..."
                  readOnly
                />
              </div>
            </FormGroup>
        ...
        <div className="flex gap-4">
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-2 bg-[#ea0031] text-white rounded-lg hover:bg-[#c9002a] disabled:opacity-50 transition"
          >
