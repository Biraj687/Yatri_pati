                ...
                <tr key={article.id} className="hover:bg-gray-50 transition-colors cursor-pointer" onClick={() => onRowClick?.(article)}>
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="font-medium text-secondary-700 text-sm truncate">{truncate(article.title, 40)}</div>
                    </div>
                  </td>
                  <td className="px-4 py-4">
                    <div className="text-sm text-gray-600">
                      {article.authors?.map(a => a.name).join(', ') || 'Nepal Explain'}
                    </div>
                  </td>
                  <td className="px-4 py-4">
                  ...
                  <td className="px-4 py-4" onClick={(e) => e.stopPropagation()}>
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded hover:bg-gray-100 text-gray-600 hover:text-[#ea0031] transition-colors"
                        title="Edit"
                      >
                        <FiEdit2 size={16} />
                      </button>
