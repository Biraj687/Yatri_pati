...
export function Footer() {
  ...
  // theme not required here; avoid unused variable error
  useTheme()
  ...
  return (
    <footer className="bg-black dark:bg-gray-950 text-white w-full">
          ...
          <div className="md:col-span-2">
            <div className="mb-6">
              <Link to="/" className="flex items-center gap-2">
                <img src={logo1Svg} alt="Nepal Explain Logo" className="h-16 w-auto" />
              </Link>
            </div>
                  ...
                  <li key={link.label}>
                    {link.isExternal ? (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-gray-300 text-sm hover:text-brand-red transition-colors font-noto"
                      >
                        {link.label}
                      </a>
                    ) : (
