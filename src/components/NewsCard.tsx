    ...
    >
      ...
      <div className={`flex-1 ${getContentPadding()} flex flex-col`}>
        ...
        {showCategory && article.category && (
          <div className="mb-2">
            <span className="inline-block px-3 py-1 text-xs font-medium bg-brand-red text-white rounded-full">
              {article.category}
            </span>
          </div>
        )}
        ...
        {/* Title */}
        <h3 className={`font-bold text-gray-900 dark:text-gray-100 group-hover:text-brand-red transition-colors ${
