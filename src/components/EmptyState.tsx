...
export function EmptyState({ 
  ...
  const iconColor = icon === 'search' ? 'text-secondary-500' : 'text-gray-400';
      ...
      action={
        onClearSearch && (
          <button
            ...
            className="px-6 py-3 bg-secondary-600 hover:bg-secondary-700 dark:hover:bg-secondary-500 text-white font-medium rounded-lg transition-colors duration-200"
          >
            खोज खाली गर्नुहोस्
          </button>
        )
