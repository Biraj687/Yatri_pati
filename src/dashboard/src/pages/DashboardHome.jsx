  ...
  const statCards = [
    {
      ...
      color: 'bg-[#ea0031] bg-opacity-10 text-[#ea0031]',
    ...
    <div className="space-y-8">
      ...
      <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 border-indigo-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div>
            ...
            <p className="text-2xl font-bold text-[#ea0031]">
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/advertisements" className="text-[#ea0031] hover:text-[#c9002a] text-sm font-medium">
            Manage Ads →
          </Link>
        </div>
        {adAnalytics.loading ? (
