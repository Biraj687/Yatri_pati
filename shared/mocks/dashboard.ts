...
export const mockSiteConfig = {
  ...
  socialLinks: [
    { platform: 'Facebook', url: 'https://facebook.com/nepalexplain' },
    { platform: 'Twitter', url: 'https://twitter.com/nepalexplain' },
    { platform: 'YouTube', url: 'https://youtube.com/nepalexplain' },
    { platform: 'Instagram', url: 'https://instagram.com/nepalexplain' }
  ],
  footer: {
