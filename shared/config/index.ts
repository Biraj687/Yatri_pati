/**
 * Environment configuration for Nepal Explain applications
...
export const config: AppConfig = {
  ...
  app: {
    name: getEnv('VITE_APP_NAME', 'Nepal Explain News Portal'),
    defaultAuthor: getEnv('VITE_DEFAULT_AUTHOR', 'Nepal Explain'),
  ...
  auth: {
    ...
    tokenKey: getEnv('VITE_AUTH_TOKEN_KEY', 'nepal_explain_auth_token'),
    userKey: getEnv('VITE_AUTH_USER_KEY', 'nepal_explain_user'),
    refreshKey: getEnv('VITE_AUTH_REFRESH_KEY', 'nepal_explain_refresh_token'),
    tokenExpiry: getNumberEnv('VITE_TOKEN_EXPIRY', 60),
    demoEmail: getEnv('VITE_DEMO_EMAIL', 'admin@nepalexplain.com'),
 ...
 */
export function getConfigForEnv(env: 'development' | 'production' | 'test' = isDevelopment ? 'development' : 'production') {
