/**
 * Unified API Client for Nepal Explain
...
export class ApiClient {
  ...
  private async handleResponse<T>(response: Response): Promise<ApiResponse<T>> {
    ...
    // Handle 204 No Content which shouldn't be parsed as JSON
    ...
    try {
      ...
      if (contentType && contentType.includes('application/json')) {
        ...
        // Return text or blob depending on your needs, or just success
        return {
          success: true,
