        ...
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full py-2 px-4 bg-[#ea0031] hover:bg-[#c9002a] text-white font-medium rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-[#ea0031] focus:ring-offset-2"
            >
              Try Again
            </button>
